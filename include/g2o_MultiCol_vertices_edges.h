...
namespace MultiColSLAM
{
	...
	// const cv::Matx61d& M_t,
	// const cv::Matx61d& M_c,
	// const Eigen::Matrix<double, 20 + 5, 1>& camModelData,
	// cv::Matx<double, 2, 32>& jacs);

	// class VertexOmniCameraParameters : public g2o::BaseVertex<5 + 20, Eigen::Matrix<double, 5 + 20, 1>>
	// {
	// public:
	...
	// 	{
	// 		Eigen::Matrix<double, 5 + 20, 1> tmpEstimate = camModel.toVector();
	// 		_estimate = tmpEstimate;
	// 	}
	// 	virtual void oplusImpl(const double* update_)
	// 	{
	// 		Eigen::Map<const Eigen::Matrix<double, 5 + 20, 1>> update(update_);
