...
namespace MultiColSLAM
{
	...
	public:
		...
		// inline Eigen::Matrix<double, 20 + 5, 1> toVector() const
		// {
		// 	Eigen::Matrix<double, 20 + 5, 1> tmp =
		// 		Eigen::Matrix<double, 20 + 5, 1>::Zero();
		// 	tmp(0, 0) = c;
		// 	tmp(1, 0) = d;
		// 	tmp(2, 0) = e;
		// 	tmp(3, 0) = u0;
		...
		// inline void fromVector(const Eigen::Matrix<double, 20 + 5, 1> tmp)
		// {
		// 	c = tmp(0, 0);
		// 	d = tmp(1, 0);
		// 	e = tmp(2, 0);
		...
		// inline cCamModelGeneral_ operator+ (const Eigen::Matrix<double, 20 + 5, 1>& values2add) const
		// {
		// 	cCamModelGeneral_ result(*this);
		// 	Eigen::Matrix<double, 20 + 5, 1> valuesOld = result.toVector();
