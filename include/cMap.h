...
namespace MultiColSLAM
{
	...
	public:
        ...
        //////kitt/////////
        void SaveKeyFrame(ofstream& f, cMultiKeyFrame* kf);
        void SaveMapPoint(ofstream& f, cMapPoint* mp);
        void SaveMap(const string& filename);
        void LoadMap(const string& filename, cMultiKeyFrameDatabase* mkfdb);
