...
namespace MultiColSLAM
{
		...
		bool *pbStopFlag)
	{
		...
		for (int c = 0; c < nrCams; ++c)
		{
			...
			// cout << "inDataaaaaaaaaaaaaaaaaaaaaaaaaaaa"<<endl;
			// cout<< vpKFs[0]->camSystem.Get_M_c_min(c) << endl;
		...
		// for (int c = 0; c < nrCams; ++c)
		// {
		// 	VertexMc_cayley* vMc = static_cast<VertexMc_cayley*>(optimizer.vertex(testCstart));
		// 	cout << "outDataaaaaaaaaaaaaaaaaaaaaaaaaaaa"<<endl;
		// 	testCstart++;
		// 	cout << vMc->estimate() <<endl;
		// }
