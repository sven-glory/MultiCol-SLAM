...
cout << "cMultiInitializer::Initialize" << endl;
		mvMatches12.clear();
		...
		//	cout << " x1: " << mvKeysRays1[idx1](0)<< " y1: " << mvKeysRays1[idx1](1)<< " z1: " << mvKeysRays1[idx1](2)<< endl;
		//	cout << " x2: " << mvKeysRays2[idx2](0)<< " y2: " << mvKeysRays2[idx2](1)<< " z2: " << mvKeysRays2[idx2](2)<< endl;
		}
		...
		for (int c = 0; c < nrCams; ++c)
		{
		//cout << "cMultiInitializer::Initialize nr_recon[c]  " << nr_recon[c] << " normsAll[c] "<< normsAll[c]<<endl;
			if (nr_recon[c] > 60 &&
				normsAll[c] > 0.06 &&
				c == 0)
			{
		...
		int currCam)
	{
		...
		for (size_t i = 0, iend = vMatches12.size(); i < iend; ++i)
		{
			...
			// cout<< "p3dC2(2):"<<p3dC2(2)<< " p3dC2(1):"<<p3dC2(1)<<" cosParallax:"<<cosParallax << " cosThresh:"<<cosThresh<<endl;
			...
			// cout<< "yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy"<<endl;
			// {
			// 	////////test start
			// 	double u = 0.0;
			// 	double v = 0.0;
			// 	camSystem.GetCamModelObj(0).WorldToImg(
			// 	p3dC1(0), p3dC1(1), p3dC1(2), u, v);
			...
			// 	camSystem.GetCamModelObj(0).ImgToWorld(
			// 	x, y, z, u, v);
			...
			// cout<< "u:"<< u<<endl;
			// cout<< "v:"<< v<<endl;
			// cout<< "kp1.pt.x: "<< cv::saturate_cast<double>(kp1.pt.x)<<endl;
			// cout<< "kp1.pt.y: "<< cv::saturate_cast<double>(kp1.pt.y)<<endl;
			// cout<< "kp1.octave: "<< kp1.octave <<endl;

			double squareError1 = cv::pow(u - cv::saturate_cast<double>(kp1.pt.x), 2) +
				cv::pow(v - cv::saturate_cast<double>(kp1.pt.y), 2);

			//cout<< "squareError1:"<<squareError1<< " th2:"<<th2 <<endl;	
			if (squareError1 > th2)
				continue;
			...
			//cout<< "squareError2:"<<cosParallax<< " th2:"<<cosThresh <<endl;	
			if (squareError2 > th2)
				continue;

			//cout<< "cosParallax:"<<cosParallax<< " cosThresh:"<<cosThresh <<endl;
		...
		{
		//	cout<< "minParallax:"<<minParallax<< " parallax:"<<parallax <<endl;
			nGood = 0;
		}
		return nGood;
	}
