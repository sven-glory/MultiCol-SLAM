...
//#pragma omp parallel for num_threads(nrCams)
	...
	cMultiFrame::~cMultiFrame()
	{
		// cout << "mp_mdBRIEF_extractorOct size:"<< mp_mdBRIEF_extractorOct.size()<< endl;
		// cout << "images size:"<< images.size()<< endl;
		// cout << "N size:"<< N.size()<< endl;
		// cout << "mvKeys size:"<< mvKeys.size()<< endl;
		// cout << "mvKeysRays size:"<< mvKeysRays.size()<< endl;
		// cout << "mFeatVecs size:"<< mFeatVecs.size()<< endl;
		// cout << "mDescriptors size:"<< mDescriptors.size()<< endl;
		// cout << "mDescriptorMasks size:"<< mDescriptorMasks.size()<< endl;
		// cout << "mvpMapPoints size:"<< mvpMapPoints.size()<< endl;
		// cout << "mvbOutlier size:"<< mvbOutlier.size()<< endl;
		// cout << "mGrids size:"<< mGrids.size()<< endl;
		// for (int i = 0; i < mGrids.size(); ++i)
		// {
		// 	cout << "mGrids size:"<< i <<":"<<mGrids[i].size()<< endl;
		// 	for (int j = 0; j < mGrids[i].size(); ++j)
		// 	{
		// 		cout << "mGrids size:"<< i <<":"<< j<<":"<<mGrids[i][j].size()<< endl;
		// 	}
		// }
		// cout << "mFeatVecs size:"<< mfGridElementWidthInv.size()<< endl;
